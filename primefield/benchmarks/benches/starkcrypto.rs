...
pub fn starkcrypto_field_mul(bench: &mut Bencher, _i: &()) {
    let a = field_h!("03d937c035c878245caf64531a5756109c53068da139362728feb561405371cb");
    let b = field_h!("0208a0a10250e382e1e4bbe2880906c2791bf6275695e02fbbc6aeff9cd8b31a");
    bench.iter(|| {
