...
contract PrimeFieldTester is PrimeField {
    ...
    function fmul_external(uint256 a, uint256 b) external pure returns (uint256 res) {
        return fmul(a, b);
    }

    function fadd_external(uint256 a, uint256 b) external pure returns (uint256 res) {
        return fadd(a, b);
    }
