...
describe('Public coin testing', () => {
    ...
    it('Sould add correctly', async function(): Promise<any> {
    ...
    it('Sould multiply correctly', async function(): Promise<any> {
    ...
    it('Sould pow correctly', async function(): Promise<any> {
    ...
    it('Sould invert correctly', async function(): Promise<any> {
