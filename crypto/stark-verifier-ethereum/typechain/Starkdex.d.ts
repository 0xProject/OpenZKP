...
interface StarkdexInterface extends Interface {
  functions: {
...
export class Starkdex extends Contract {
  connect(signerOrProvider: Signer | Provider | string): Starkdex;
  attach(addressOrName: string): Starkdex;
  deployed(): Promise<Starkdex>;

  on(event: EventFilter | string, listener: Listener): Starkdex;
  once(event: EventFilter | string, listener: Listener): Starkdex;
  addListener(eventName: EventFilter | string, listener: Listener): Starkdex;
  removeAllListeners(eventName: EventFilter | string): Starkdex;
  removeListener(eventName: any, listener: Listener): Starkdex;

  interface: StarkdexInterface;
