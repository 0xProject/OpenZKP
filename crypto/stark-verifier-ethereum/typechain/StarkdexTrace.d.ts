...
interface StarkdexTraceInterface extends Interface {
  functions: {
...
export class StarkdexTrace extends Contract {
  connect(signerOrProvider: Signer | Provider | string): StarkdexTrace;
  attach(addressOrName: string): StarkdexTrace;
  deployed(): Promise<StarkdexTrace>;

  on(event: EventFilter | string, listener: Listener): StarkdexTrace;
  once(event: EventFilter | string, listener: Listener): StarkdexTrace;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): StarkdexTrace;
  removeAllListeners(eventName: EventFilter | string): StarkdexTrace;
  removeListener(eventName: any, listener: Listener): StarkdexTrace;

  interface: StarkdexTraceInterface;
