...
interface TrivialFibInterface extends Interface {
    functions: {
...
export class TrivialFib extends Contract {
    connect(signerOrProvider: Signer | Provider | string): TrivialFib;
    attach(addressOrName: string): TrivialFib;
    deployed(): Promise<TrivialFib>;

    on(event: EventFilter | string, listener: Listener): TrivialFib;
    once(event: EventFilter | string, listener: Listener): TrivialFib;
    addListener(eventName: EventFilter | string, listener: Listener): TrivialFib;
    removeAllListeners(eventName: EventFilter | string): TrivialFib;
    removeListener(eventName: any, listener: Listener): TrivialFib;

    interface: TrivialFibInterface;
