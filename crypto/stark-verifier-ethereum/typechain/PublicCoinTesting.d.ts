...
export class PublicCoinTesting extends Contract {
    ...
    addListener(eventName: EventFilter | string, listener: Listener): PublicCoinTesting;
    ...
    estimate: {
        init_and_read(starting_data: Arrayish, number: BigNumberish): Promise<BigNumber>;
