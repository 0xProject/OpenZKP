...
interface ProofOfWorkTestingInterface extends Interface {
    functions: {
        check_proof_of_work_external: TypedFunctionDescription<{
            encode([init_digest, pow_nonce, pow_bits]: [Arrayish, Arrayish, BigNumberish]): string;
        }>;
    };
...
export class ProofOfWorkTesting extends Contract {
    ...
    addListener(eventName: EventFilter | string, listener: Listener): ProofOfWorkTesting;
    ...
    check_proof_of_work_external(init_digest: Arrayish, pow_nonce: Arrayish, pow_bits: BigNumberish): Promise<boolean>;
