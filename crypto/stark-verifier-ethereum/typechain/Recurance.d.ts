...
interface RecuranceInterface extends Interface {
    functions: {
...
export class Recurance extends Contract {
    connect(signerOrProvider: Signer | Provider | string): Recurance;
    attach(addressOrName: string): Recurance;
    deployed(): Promise<Recurance>;

    on(event: EventFilter | string, listener: Listener): Recurance;
    once(event: EventFilter | string, listener: Listener): Recurance;
    addListener(eventName: EventFilter | string, listener: Listener): Recurance;
    removeAllListeners(eventName: EventFilter | string): Recurance;
    removeListener(eventName: any, listener: Listener): Recurance;

    interface: RecuranceInterface;
