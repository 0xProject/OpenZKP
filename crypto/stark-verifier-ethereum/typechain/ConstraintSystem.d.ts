...
interface ConstraintSystemInterface extends Interface {
    functions: {
        constraint_calculations: TypedFunctionDescription<{
            encode([proof, params, queries, oods_point, constraint_coeffiencts, oods_coeffiencts]: [
                {
...
export class ConstraintSystem extends Contract {
    connect(signerOrProvider: Signer | Provider | string): ConstraintSystem;
    attach(addressOrName: string): ConstraintSystem;
    deployed(): Promise<ConstraintSystem>;

    on(event: EventFilter | string, listener: Listener): ConstraintSystem;
    once(event: EventFilter | string, listener: Listener): ConstraintSystem;
    addListener(eventName: EventFilter | string, listener: Listener): ConstraintSystem;
    removeAllListeners(eventName: EventFilter | string): ConstraintSystem;
    removeListener(eventName: any, listener: Listener): ConstraintSystem;

    interface: ConstraintSystemInterface;
