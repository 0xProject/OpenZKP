...
interface ConstantTraceInterface extends Interface {
  functions: {
...
export class ConstantTrace extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ConstantTrace;
  attach(addressOrName: string): ConstantTrace;
  deployed(): Promise<ConstantTrace>;

  on(event: EventFilter | string, listener: Listener): ConstantTrace;
  once(event: EventFilter | string, listener: Listener): ConstantTrace;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): ConstantTrace;
  removeAllListeners(eventName: EventFilter | string): ConstantTrace;
  removeListener(eventName: any, listener: Listener): ConstantTrace;

  interface: ConstantTraceInterface;
