...
impl Verifiable for Claim {
    fn constraints(&self) -> Constraints {
        ...
        Constraints::new(vec![
            ...
            on_hash_loop_rows(simple_conditional(row_add[0].clone(), Trace(3, 1) - Trace(3, 0), Trace(0,0))),
            on_hash_loop_rows(simple_conditional(row_add[1].clone(), Trace(4, 1) - Trace(4, 0), Trace(0,0))),
