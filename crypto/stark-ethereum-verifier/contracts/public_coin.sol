...
contract PublicCoin is Hashing {
    ...
    function write_bytes32(bytes32 to_be_written, Coin memory coin) internal {
    ...
    // Note that because this is a memory refrence this updates the coin.
    function read_bytes32(Coin memory coin) internal returns(bytes32) {
    ...
    function init_coin(bytes memory starting_data) internal returns(Coin memory) {
