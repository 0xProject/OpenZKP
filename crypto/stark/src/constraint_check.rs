...
pub(crate) fn check_constraints(constraint: &Constraints, table: &TraceTable) -> Result<(), (usize, usize)> {
    ...
    for row in 0..table.num_rows() {
        ...
        for (which, expression) in constraint.expressions().iter().enumerate() {
