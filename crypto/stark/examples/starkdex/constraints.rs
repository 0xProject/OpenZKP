...
fn state_transition_constraints() -> Vec<RationalExpression> {
    ...
    (prev_authentication_hashes_ec_subset_sum_bit_neg.clone().clone() * (Trace(0, 1) - Trace(0, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - 1.into()), // prev_authentication/hashes/ec_subset_sum/copy_point/x
    (prev_authentication_hashes_ec_subset_sum_bit_neg.clone().clone() * (Trace(1, 1) - Trace(1, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - 1.into()), // prev_authentication/hashes/ec_subset_sum/copy_point/y
...
fn hash_pool_constraints() -> Vec<RationalExpression> {
    ...
    vec![
    (ec_subset_sum_bit.clone().clone() * (ec_subset_sum_bit.clone().clone() - 1.into())) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - 1.into()), // ec_subset_sum/booleanity_test
    ...
    (ec_subset_sum_bit.clone().clone() * (Trace(8, 2) - hash_pool_points_y) - Trace(8, 1) * (Trace(8, 0) - hash_pool_points_x.clone())) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - 1.into()), // ec_subset_sum/add_points/slope
    (Trace(8, 1) * Trace(8, 1) - ec_subset_sum_bit.clone().clone() * (Trace(8, 0) + hash_pool_points_x.clone() + Trace(8, 4))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - 1.into()), // ec_subset_sum/add_points/x
    (ec_subset_sum_bit.clone().clone() * (Trace(8, 2) + Trace(8, 6)) - Trace(8, 1) * (Trace(8, 0) - Trace(8, 4))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - 1.into()), // ec_subset_sum/add_points/y
