...
fn signature_verification_constraints() -> Vec<RationalExpression> {
    fn exponentiate_generator_constraints() -> Vec<RationalExpression> {
        ...
        vec![
        (bit.clone() * (bit.clone() - Constant(1.into()))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // booleanity_test
        ...
        (bit.clone() * (Trace(9, 6) - ecdsa_points_y) - Trace(9, 0) * (Trace(9, 8) - ecdsa_points_x.clone())) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // add_points/slope
        (Trace(9, 0) * Trace(9, 0) - bit.clone() * (Trace(9, 8) + ecdsa_points_x.clone() + Trace(9, 6))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // add_points/x
        (bit.clone() * (Trace(9, 6) + Trace(9, 4)) - Trace(9, 0) * (Trace(9, 8) - Trace(9, 6))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // add_points/y
        (Trace(9, 4) * (Trace(9, 8) - ecdsa_points_x.clone()) - Constant(1.into())) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // add_points/x_diff_inv
        (bit_neg.clone() * (Trace(9, 6) - Trace(9, 8))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // copy_point/x
        (bit_neg.clone() * (Trace(9, 4) - Trace(9, 6))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // copy_point/y
        ]
    }
    ...
    fn exponentiate_key_constraints() -> Vec<RationalExpression> {
        ...
        vec![
        (exponentiate_key_bit.clone() * (exponentiate_key_bit.clone() - Constant(1.into()))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // exponentiate_key/booleanity_test
        ...
        (exponentiate_key_bit.clone() * (Trace(9, 8) - Trace(9, 2)) - Trace(9, 0) * (Trace(9, 8) - Trace(9, 0))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // exponentiate_key/add_points/slope
        (Trace(9, 0) * Trace(9, 0) - exponentiate_key_bit.clone() * (Trace(9, 8) + Trace(9, 0) + Trace(9, 2))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // exponentiate_key/add_points/x
        (exponentiate_key_bit.clone() * (Trace(9, 8) + Trace(9, 2)) - Trace(9, 0) * (Trace(9, 8) - Trace(9, 2))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // exponentiate_key/add_points/y
        ...
        (exponentiate_key_bit_neg.clone() * (Trace(9, 2) - Trace(9, 8))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // exponentiate_key/copy_point/x
        (exponentiate_key_bit_neg.clone() * (Trace(9, 2) - Trace(9, 8))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // exponentiate_key/copy_point/y
        ]
    }
    ...
    let mut result = vec![
    (doubling_key_x_squared.clone() + doubling_key_x_squared.clone() + doubling_key_x_squared.clone() + sig_config.alpha.clone() - (Trace(9, 2) + Trace(9, 2)) * Trace(9, 6)) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // doubling_key/slope
...
fn state_transition_constraints() -> Vec<RationalExpression> {
    ...
    vec![
    (side_bit_extraction_bit_0.clone() * side_bit_extraction_bit_0.clone() - side_bit_extraction_bit_0.clone()) * (X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) / (X.pow(trace_length / 512) - Constant(1.into())), // side_bit_extraction/bit
    (Trace(6, 5)) / (X.pow(trace_length / 16384) - trace_generator.pow(path_length * trace_length / 32)), // side_bit_extraction/zero
    (prev_authentication_hashes_ec_subset_sum_bit.clone() * (prev_authentication_hashes_ec_subset_sum_bit.clone() - Constant(1.into()))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // prev_authentication/hashes/ec_subset_sum/booleanity_test
    ...
    (prev_authentication_hashes_ec_subset_sum_bit.clone() * (Trace(1, 0) - merkle_hash_points_y.clone()) - Trace(2, 0) * (Trace(0, 0) - merkle_hash_points_x.clone())) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // prev_authentication/hashes/ec_subset_sum/add_points/slope
    (Trace(2, 0) * Trace(2, 0) - prev_authentication_hashes_ec_subset_sum_bit.clone() * (Trace(0, 0) + merkle_hash_points_x.clone() + Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // prev_authentication/hashes/ec_subset_sum/add_points/x
    (prev_authentication_hashes_ec_subset_sum_bit.clone() * (Trace(1, 0) + Trace(1, 1)) - Trace(2, 0) * (Trace(0, 0) - Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // prev_authentication/hashes/ec_subset_sum/add_points/y
    (prev_authentication_hashes_ec_subset_sum_bit_neg.clone().clone() * (Trace(0, 1) - Trace(0, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // prev_authentication/hashes/ec_subset_sum/copy_point/x
    (prev_authentication_hashes_ec_subset_sum_bit_neg.clone().clone() * (Trace(1, 1) - Trace(1, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // prev_authentication/hashes/ec_subset_sum/copy_point/y
    ...
    ((Constant(1.into()) - side_bit_extraction_bit_1.clone()) * (Trace(0, 1) - Trace(3, 2))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // prev_authentication/copy_prev_to_left
    (side_bit_extraction_bit_1.clone() * (Trace(0, 1) - Trace(3, 8))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // prev_authentication/copy_prev_to_right
    (new_authentication_hashes_ec_subset_sum_bit.clone() * (new_authentication_hashes_ec_subset_sum_bit.clone() - Constant(1.into()))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // new_authentication/hashes/ec_subset_sum/booleanity_test
    ...
    (new_authentication_hashes_ec_subset_sum_bit.clone() * (Trace(5, 0) - merkle_hash_points_y.clone()) - Trace(6, 0) * (Trace(4, 0) - merkle_hash_points_x.clone())) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // new_authentication/hashes/ec_subset_sum/add_points/slope
    (Trace(6, 0) * Trace(6, 0) - new_authentication_hashes_ec_subset_sum_bit.clone() * (Trace(4, 0) + merkle_hash_points_x.clone() + Trace(4, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // new_authentication/hashes/ec_subset_sum/add_points/x
    (new_authentication_hashes_ec_subset_sum_bit.clone() * (Trace(5, 0) + Trace(5, 1)) - Trace(6, 0) * (Trace(4, 0) - Trace(4, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // new_authentication/hashes/ec_subset_sum/add_points/y
    (new_authentication_hashes_ec_subset_sum_bit_neg.clone() * (Trace(4, 1) - Trace(4, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // new_authentication/hashes/ec_subset_sum/copy_point/x
    (new_authentication_hashes_ec_subset_sum_bit_neg.clone() * (Trace(5, 1) - Trace(5, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // new_authentication/hashes/ec_subset_sum/copy_point/y
    ...
    ((Constant(1.into()) - side_bit_extraction_bit_1.clone()) * (Trace(4, 1) - Trace(7, 2))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // new_authentication/copy_prev_to_left
    (side_bit_extraction_bit_1.clone() * (Trace(4, 1) - Trace(7, 8))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // new_authentication/copy_prev_to_right
    (prev_authentication_sibling_0 - new_authentication_sibling_0) * (X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) / (X.pow(trace_length / 512) - Constant(1.into())), // same_siblings
    (prev_authentication_leaf_0 - Trace(8, 2)) / (X.pow(trace_length / 16384) - Constant(1.into())), // merkle_set_prev_leaf
    (new_authentication_leaf_0 - Trace(8, 4)) / (X.pow(trace_length / 16384) - Constant(1.into())), // merkle_set_new_leaf
    ]
}
...
fn hash_pool_constraints() -> Vec<RationalExpression> {
    ...
    vec![
    (ec_subset_sum_bit.clone().clone() * (ec_subset_sum_bit.clone().clone() - Constant(1.into()))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // ec_subset_sum/booleanity_test
    ...
    (ec_subset_sum_bit.clone().clone() * (Trace(8, 2) - hash_pool_points_y) - Trace(8, 1) * (Trace(8, 0) - hash_pool_points_x.clone())) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // ec_subset_sum/add_points/slope
    (Trace(8, 1) * Trace(8, 1) - ec_subset_sum_bit.clone().clone() * (Trace(8, 0) + hash_pool_points_x.clone() + Trace(8, 4))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // ec_subset_sum/add_points/x
    (ec_subset_sum_bit.clone().clone() * (Trace(8, 2) + Trace(8, 6)) - Trace(8, 1) * (Trace(8, 0) - Trace(8, 4))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // ec_subset_sum/add_points/y
    (ec_subset_sum_bit_neg.clone() * (Trace(8, 4) - Trace(8, 0))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // ec_subset_sum/copy_point/x
    (ec_subset_sum_bit_neg.clone() * (Trace(8, 6) - Trace(8, 2))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // ec_subset_sum/copy_point/y
...
fn other_constraints() -> Vec<RationalExpression> {
    ...
    (amounts_range_check_bit_0.clone() * amounts_range_check_bit_0.clone() - amounts_range_check_bit_0.clone()) * (X.pow(trace_length / 8192) - trace_generator.pow(63 * trace_length / 64)) / (X.pow(trace_length / 128) - Constant(1.into())), // amounts_range_check/bit
