...
fn constraints(parameters: &Parameters) -> Vec<RationalExpression> {
    ...
    (Trace(8, 0) - hash_shift_x) / (X.pow(trace_length / 2048) - 1.into()), // hash_pool/hash/init/x
    (Trace(8, 2) - hash_shift_y) / (X.pow(trace_length / 2048) - 1.into()), // hash_pool/hash/init/y
    ...
    (Trace(0, 0) - hash_shift_x) / (X.pow(trace_length / 512) - 1.into()), // state_transition/merkle_update/prev_authentication/hashes/init/x
    (Trace(1, 0) - hash_shift_y) / (X.pow(trace_length / 512) - 1.into()), // state_transition/merkle_update/prev_authentication/hashes/init/y
    ...
    (Trace(4, 0) - hash_shift_x) / (X.pow(trace_length / 512) - 1.into()), // state_transition/merkle_update/new_authentication/hashes/init/x
    (Trace(5, 0) - hash_shift_y) / (X.pow(trace_length / 512) - 1.into()), // state_transition/merkle_update/new_authentication/hashes/init/y
