...
fn state_transition_constraints() -> Vec<RationalExpression> {
    ...
    vec![
    (side_bit_extraction__bit_0.clone() * side_bit_extraction__bit_0.clone() - side_bit_extraction__bit_0.clone()) * (X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/side_bit_extraction/bit
    ...
    (prev_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(1, 0) - merkle_hash_points__y.clone()) - Trace(2, 0) * (Trace(0, 0) - merkle_hash_points__x.clone())) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_points/slope
    (Trace(2, 0) * Trace(2, 0) - prev_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(0, 0) + merkle_hash_points__x.clone() + Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_points/x
    (prev_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(1, 0) + Trace(1, 1)) - Trace(2, 0) * (Trace(0, 0) - Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_points/y
    (prev_authentication__hashes__ec_subset_sum__bit_neg.clone().clone() * (Trace(0, 1) - Trace(0, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/copy_point/x
    (prev_authentication__hashes__ec_subset_sum__bit_neg.clone().clone() * (Trace(1, 1) - Trace(1, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/copy_point/y
    ...
    ((Constant(1.into()) - side_bit_extraction__bit_1.clone()) * (Trace(0, 1) - Trace(3, 2))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/copy_prev_to_left
    (side_bit_extraction__bit_1.clone() * (Trace(0, 1) - Trace(3, 8))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/copy_prev_to_right
    (new_authentication__hashes__ec_subset_sum__bit.clone() * (new_authentication__hashes__ec_subset_sum__bit.clone() - Constant(1.into()))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/booleanity_test
    ...
    (new_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(5, 0) - merkle_hash_points__y.clone()) - Trace(6, 0) * (Trace(4, 0) - merkle_hash_points__x.clone())) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/add_points/slope
    (Trace(6, 0) * Trace(6, 0) - new_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(4, 0) + merkle_hash_points__x.clone() + Trace(4, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/add_points/x
    (new_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(5, 0) + Trace(5, 1)) - Trace(6, 0) * (Trace(4, 0) - Trace(4, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/add_points/y
    (new_authentication__hashes__ec_subset_sum__bit_neg.clone() * (Trace(4, 1) - Trace(4, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/copy_point/x
    (new_authentication__hashes__ec_subset_sum__bit_neg.clone() * (Trace(5, 1) - Trace(5, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/copy_point/y
    ...
    ((Constant(1.into()) - side_bit_extraction__bit_1.clone()) * (Trace(4, 1) - Trace(7, 2))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/new_authentication/copy_prev_to_left
    (side_bit_extraction__bit_1.clone() * (Trace(4, 1) - Trace(7, 8))) * ((X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) * (X.pow(trace_length / 16384) - trace_generator.pow(15 * trace_length / 16))) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/new_authentication/copy_prev_to_right
    (prev_authentication__sibling_0 - new_authentication__sibling_0) * (X.pow(trace_length / 16384) - trace_generator.pow(31 * trace_length / 32)) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/same_siblings
    (prev_authentication__leaf_0 - Trace(8, 2)) / (X.pow(trace_length / 16384) - Constant(1.into())), // state_transition/merkle_set_prev_leaf
    (new_authentication__leaf_0 - Trace(8, 4)) / (X.pow(trace_length / 16384) - Constant(1.into())), // state_transition/merkle_set_new_leaf
    ]
}
