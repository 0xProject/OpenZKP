...
fn constraints(parameters: &Parameters) -> Vec<RationalExpression> {
    ...
    let ecdsa_points__x = Polynomial(DensePolynomial::new(&ECDSA_POINTS_X), Box::new(X.pow(20)));
    let ecdsa_points__y = Polynomial(DensePolynomial::new(&ECDSA_POINTS_Y), Box::new(X.pow(20)));
    ...
    let merkle_hash_points__x = Polynomial(DensePolynomial::new(&PEDERSEN_POINTS_X), Box::new(X.pow(20)));
    let merkle_hash_points__y = Polynomial(DensePolynomial::new(&PEDERSEN_POINTS_Y), Box::new(X.pow(20)));
    let (hash_shift_x, hash_shift_y) = get_coordinates(&parameters.hash_shift_point);

    let hash_pool_points__x = Polynomial(DensePolynomial::new(&PEDERSEN_POINTS_X), Box::new(X.pow(20)));
    let hash_pool_points__y = Polynomial(DensePolynomial::new(&PEDERSEN_POINTS_Y), Box::new(X.pow(20)));
    ...
    let state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit = Trace(3, 0) - (Trace(3, 1) + Trace(3, 1));
    let state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg = Constant(1.into()) - state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit.clone();
    ...
    (state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(1, 0) - merkle_hash_points__y.clone()) - Trace(2, 0) * (Trace(0, 0) - merkle_hash_points__x.clone())) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - 1.into()), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_points/slope
    (Trace(2, 0) * Trace(2, 0) - state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(0, 0) + merkle_hash_points__x.clone() + Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - 1.into()), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_points/x
    (state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit.clone() * (Trace(1, 0) + Trace(1, 1)) - Trace(2, 0) * (Trace(0, 0) - Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - 1.into()), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_points/y
    (state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg.clone() * (Trace(0, 1) - Trace(0, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - 1.into()), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/copy_point/x
    (state_transition_merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg.clone() * (Trace(1, 1) - Trace(1, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - 1.into()), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/copy_point/y
    ...
    (amounts_range_check__bit_0.clone() * amounts_range_check__bit_0.clone() - amounts_range_check__bit_0.clone()) * (X.pow(trace_length / 8192) - trace_generator.pow(63 * trace_length / 64)) / (X.pow(trace_length / 128) - 1.into()), // amounts_range_check/bit
    ...
    (sig_verify__doubling_key__x_squared.clone() + sig_verify__doubling_key__x_squared.clone() + sig_verify__doubling_key__x_squared.clone() + alpha.clone() - (Trace(9, 32) + Trace(9, 32)) * Trace(9, 16)) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - 1.into()), // sig_verify/doubling_key/slope
    ...
    (sig_verify_exponentiate_generator_bit.clone() * (Trace(9, 36) - ecdsa_points__y) - Trace(9, 100) * (Trace(9, 68) - ecdsa_points__x.clone())) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - 1.into()), // sig_verify/exponentiate_generator/add_points/slope
    (Trace(9, 100) * Trace(9, 100) - sig_verify_exponentiate_generator_bit.clone() * (Trace(9, 68) + ecdsa_points__x.clone() + Trace(9, 196))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - 1.into()), // sig_verify/exponentiate_generator/add_points/x
    ...
    (Trace(9, 84) * (Trace(9, 68) - ecdsa_points__x.clone()) - 1.into()) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - 1.into()), // sig_verify/exponentiate_generator/add_points/x_diff_inv
