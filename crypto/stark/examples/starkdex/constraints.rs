...
struct SignatureConfig {
    pub shift_X: Point,
    pub alpha: RationalExpression::Constant,
    pub beta: RationalExpression::Constant,
}

struct Point {
    pub x:  RationalExpression::Constant,
    pub y:  RationalExpression::Constant,
}
...
fn constraints() -> Vec<RationalExpression> {
    ...
    (hash_pool__hash__ec_subset_sum__bit * (Trace(8, 2) - hash_pool_Xs__y) - Trace(8, 1) * (Trace(8, 0) - hash_pool_Xs__x)) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // hash_pool/hash/ec_subset_sum/add_Xs/slope
    (Trace(8, 1) * Trace(8, 1) - hash_pool__hash__ec_subset_sum__bit * (Trace(8, 0) + hash_pool_Xs__x + Trace(8, 4))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // hash_pool/hash/ec_subset_sum/add_Xs/x
    (hash_pool__hash__ec_subset_sum__bit * (Trace(8, 2) + Trace(8, 6)) - Trace(8, 1) * (Trace(8, 0) - Trace(8, 4))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // hash_pool/hash/ec_subset_sum/add_Xs/y
    (hash_pool__hash__ec_subset_sum__bit_neg * (Trace(8, 4) - Trace(8, 0))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // hash_pool/hash/ec_subset_sum/copy_X/x
    (hash_pool__hash__ec_subset_sum__bit_neg * (Trace(8, 6) - Trace(8, 2))) * (X.pow(trace_length / 1024) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 4) - Constant(1.into())), // hash_pool/hash/ec_subset_sum/copy_X/y
    (Trace(8, 4) - Trace(8, 0)) * (X.pow(trace_length / 2048) - trace_generator.pow(trace_length / 2)) / (X.pow(trace_length / 1024) - Constant(1.into())), // hash_pool/hash/copy_X/x
    (Trace(8, 6) - Trace(8, 2)) * (X.pow(trace_length / 2048) - trace_generator.pow(trace_length / 2)) / (X.pow(trace_length / 1024) - Constant(1.into())), // hash_pool/hash/copy_X/y
    (Trace(8, 0) - shift_X.x) / (X.pow(trace_length / 2048) - Constant(1.into())), // hash_pool/hash/init/x
    (Trace(8, 2) - shift_X.y) / (X.pow(trace_length / 2048) - Constant(1.into())), // hash_pool/hash/init/y
    ...
    (state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit * (Trace(1, 0) - merkle_hash_Xs__y) - Trace(2, 0) * (Trace(0, 0) - merkle_hash_Xs__x)) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_Xs/slope
    (Trace(2, 0) * Trace(2, 0) - state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit * (Trace(0, 0) + merkle_hash_Xs__x + Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_Xs/x
    (state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit * (Trace(1, 0) + Trace(1, 1)) - Trace(2, 0) * (Trace(0, 0) - Trace(0, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/add_Xs/y
    (state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg * (Trace(0, 1) - Trace(0, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/copy_X/x
    (state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg * (Trace(1, 1) - Trace(1, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/copy_X/y
    (Trace(0, 6) - Trace(0, 5)) * (X.pow(trace_length / 512) - trace_generator.pow(trace_length / 2)) / (X.pow(trace_length / 256) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/copy_X/x
    (Trace(1, 6) - Trace(1, 5)) * (X.pow(trace_length / 512) - trace_generator.pow(trace_length / 2)) / (X.pow(trace_length / 256) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/copy_X/y
    (Trace(0, 0) - shift_X.x) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/init/x
    (Trace(1, 0) - shift_X.y) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/prev_authentication/hashes/init/y
    ...
    (state_transition__merkle_update__new_authentication__hashes__ec_subset_sum__bit * (Trace(5, 0) - merkle_hash_Xs__y) - Trace(6, 0) * (Trace(4, 0) - merkle_hash_Xs__x)) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/add_Xs/slope
    (Trace(6, 0) * Trace(6, 0) - state_transition__merkle_update__new_authentication__hashes__ec_subset_sum__bit * (Trace(4, 0) + merkle_hash_Xs__x + Trace(4, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/add_Xs/x
    (state_transition__merkle_update__new_authentication__hashes__ec_subset_sum__bit * (Trace(5, 0) + Trace(5, 1)) - Trace(6, 0) * (Trace(4, 0) - Trace(4, 1))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/add_Xs/y
    (state_transition__merkle_update__new_authentication__hashes__ec_subset_sum__bit_neg * (Trace(4, 1) - Trace(4, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/copy_X/x
    (state_transition__merkle_update__new_authentication__hashes__ec_subset_sum__bit_neg * (Trace(5, 1) - Trace(5, 0))) * (X.pow(trace_length / 256) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/copy_X/y
    (Trace(4, 6) - Trace(4, 5)) * (X.pow(trace_length / 512) - trace_generator.pow(trace_length / 2)) / (X.pow(trace_length / 256) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/copy_X/x
    (Trace(5, 6) - Trace(5, 5)) * (X.pow(trace_length / 512) - trace_generator.pow(trace_length / 2)) / (X.pow(trace_length / 256) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/copy_X/y
    (Trace(4, 0) - shift_X.x) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/init/x
    (Trace(5, 0) - shift_X.y) / (X.pow(trace_length / 512) - Constant(1.into())), // state_transition/merkle_update/new_authentication/hashes/init/y
    ...
    (sig_verify__exponentiate_generator__bit * (Trace(9, 6) - ecdsa_Xs__y) - Trace(9, 0) * (Trace(9, 8) - ecdsa_Xs__x)) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // sig_verify/exponentiate_generator/add_Xs/slope
    (Trace(9, 0) * Trace(9, 0) - sig_verify__exponentiate_generator__bit * (Trace(9, 8) + ecdsa_Xs__x + Trace(9, 6))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // sig_verify/exponentiate_generator/add_Xs/x
    (sig_verify__exponentiate_generator__bit * (Trace(9, 6) + Trace(9, 4)) - Trace(9, 0) * (Trace(9, 8) - Trace(9, 6))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // sig_verify/exponentiate_generator/add_Xs/y
    (Trace(9, 4) * (Trace(9, 8) - ecdsa_Xs__x) - Constant(1.into())) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // sig_verify/exponentiate_generator/add_Xs/x_diff_inv
    (sig_verify__exponentiate_generator__bit_neg * (Trace(9, 6) - Trace(9, 8))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // sig_verify/exponentiate_generator/copy_X/x
    (sig_verify__exponentiate_generator__bit_neg * (Trace(9, 4) - Trace(9, 6))) * (X.pow(trace_length / 32768) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 128) - Constant(1.into())), // sig_verify/exponentiate_generator/copy_X/y
    ...
    (sig_verify__exponentiate_key__bit * (Trace(9, 8) - Trace(9, 2)) - Trace(9, 0) * (Trace(9, 8) - Trace(9, 0))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // sig_verify/exponentiate_key/add_Xs/slope
    (Trace(9, 0) * Trace(9, 0) - sig_verify__exponentiate_key__bit * (Trace(9, 8) + Trace(9, 0) + Trace(9, 2))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // sig_verify/exponentiate_key/add_Xs/x
    (sig_verify__exponentiate_key__bit * (Trace(9, 8) + Trace(9, 2)) - Trace(9, 0) * (Trace(9, 8) - Trace(9, 2))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // sig_verify/exponentiate_key/add_Xs/y
    (Trace(9, 6) * (Trace(9, 8) - Trace(9, 0)) - Constant(1.into())) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // sig_verify/exponentiate_key/add_Xs/x_diff_inv
    (sig_verify__exponentiate_key__bit_neg * (Trace(9, 2) - Trace(9, 8))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // sig_verify/exponentiate_key/copy_X/x
    (sig_verify__exponentiate_key__bit_neg * (Trace(9, 2) - Trace(9, 8))) * (X.pow(trace_length / 16384) - trace_generator.pow(255 * trace_length / 256)) / (X.pow(trace_length / 64) - Constant(1.into())), // sig_verify/exponentiate_key/copy_X/y
    (Trace(9, 8) - sig_config.shift_X.x) / (X.pow(trace_length / 32768) - Constant(1.into())), // sig_verify/init_gen/x
    (Trace(9, 6) + sig_config.shift_X.y) / (X.pow(trace_length / 32768) - Constant(1.into())), // sig_verify/init_gen/y
    (Trace(9, 8) - sig_config.shift_X.x) / (X.pow(trace_length / 16384) - Constant(1.into())), // sig_verify/init_key/x
    (Trace(9, 8) - sig_config.shift_X.y) / (X.pow(trace_length / 16384) - Constant(1.into())), // sig_verify/init_key/y
    ...
    (Trace(9, 2) + sig_config.shift_X.y - Trace(8, 9) * (Trace(9, 2) - sig_config.shift_X.x)) / (X.pow(trace_length / 32768) - Constant(1.into())), // sig_verify/extract_r/slope
    (Trace(8, 9) * Trace(8, 9) - (Trace(9, 2) + sig_config.shift_X.x + Trace(9, 4))) / (X.pow(trace_length / 32768) - Constant(1.into())), // sig_verify/extract_r/x
    (Trace(8, 3) * (Trace(9, 2) - sig_config.shift_X.x) - Constant(1.into())) / (X.pow(trace_length / 32768) - Constant(1.into())), // sig_verify/extract_r/x_diff_inv
