...
use num::{Zero, One, Integer, bigint::BigUint, traits::FromPrimitive, traits::Inv};
...
fn field_add(crit: &mut Criterion) {
    ...
    crit.bench_function("Field add", move |bench| bench.iter(|| {
...
fn field_mul(crit: &mut Criterion) {
    let a = FieldElement::new(&[0x0f3855f5, 0x37862eb2, 0x275b919f, 0x325329cb, 0xe968e6a2, 0xa2ceee5c, 0xd5f1d547, 0x07211989]);
    let b = FieldElement::new(&[0x32c781dd, 0x6f6a3b68, 0x3bac723c, 0xd5893114, 0xd0178b37, 0x5476714f, 0x1c567d5a, 0x0219cad4]);
    crit.bench_function("Field mul", move |bench| bench.iter(|| {
        black_box(a.clone() * b.clone());
    }));
}
...
fn field_inv(crit: &mut Criterion) {
    let a = FieldElement::new(&[0x0f3855f5, 0x37862eb2, 0x275b919f, 0x325329cb, 0xe968e6a2, 0xa2ceee5c, 0xd5f1d547, 0x07211989]);
    crit.bench_function("Field inv", move |bench| bench.iter(|| {
