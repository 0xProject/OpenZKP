...
contract DexConstraintPoly {
  ...
  // [0x220, 0x240) - path_length
  // [0x240, 0x260) - sig_config.alpha
  // [0x260, 0x280) - sig_config.beta
  // [0x280, 0x2a0) - vault_shift
  // [0x2a0, 0x2c0) - amount_shift
  // [0x2c0, 0x2e0) - trade_shift
  // [0x2e0, 0x300) - n_modifications
  // [0x300, 0x320) - initial_root
  // [0x320, 0x340) - final_root
  // [0x340, 0x360) - n_settlements
  // [0x360, 0x380) - trace_generator
  // [0x380, 0x3a0) - oods_point
  // [0x3a0, 0x21a0) - coefficients
  // [0x21a0, 0x3180) - oods_values
  // ----------------------- end of input data - -------------------------
  // [0x3180, 0x31a0) - composition_degree_bound
  // [0x31a0, 0x31c0) - intermediate_value/hash_pool/hash/ec_subset_sum/bit
  // [0x31c0, 0x31e0) - intermediate_value/hash_pool/hash/ec_subset_sum/bit_neg
  // [0x31e0, 0x3200) - intermediate_value/state_transition/merkle_update/side_bit_extraction/bit_0
  // [0x3200, 0x3220) - intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit
  // [0x3220, 0x3240) - intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit_neg
  // [0x3240, 0x3260) - intermediate_value/state_transition/merkle_update/side_bit_extraction/bit_1
  // [0x3260, 0x3280) - intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit
  // [0x3280, 0x32a0) - intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit_neg
  // [0x32a0, 0x32c0) - intermediate_value/state_transition/merkle_update/prev_authentication/sibling_0
  // [0x32c0, 0x32e0) - intermediate_value/state_transition/merkle_update/new_authentication/sibling_0
  // [0x32e0, 0x3300) - intermediate_value/state_transition/merkle_update/prev_authentication/leaf_0
  // [0x3300, 0x3320) - intermediate_value/state_transition/merkle_update/new_authentication/leaf_0
  // [0x3320, 0x3340) - intermediate_value/amounts_range_check/bit_0
  // [0x3340, 0x3360) - intermediate_value/sig_verify/doubling_key/x_squared
  // [0x3360, 0x3380) - intermediate_value/sig_verify/exponentiate_generator/bit
  // [0x3380, 0x33a0) - intermediate_value/sig_verify/exponentiate_generator/bit_neg
  // [0x33a0, 0x33c0) - intermediate_value/sig_verify/exponentiate_key/bit
  // [0x33c0, 0x33e0) - intermediate_value/sig_verify/exponentiate_key/bit_neg
  // [0x33e0, 0x36a0) - expmods
  // [0x36a0, 0x39c0) - denominator_invs
  // [0x39c0, 0x3ce0) - denominators
  // [0x3ce0, 0x3e20) - numerators
  // [0x3e20, 0x4160) - adjustments
  // [0x4160, 0x4220) - expmod_context
  ...
  function() external {
    ...
    assembly {
...

      {
        ...
        mstore(0x33e0, expmod(point, div(/*trace_length*/ mload(0x1c0), 4), PRIME))

        // expmods[1] = point^(trace_length / 1024)
        mstore(0x3400, expmod(point, div(/*trace_length*/ mload(0x1c0), 1024), PRIME))

        // expmods[2] = point^(trace_length / 2048)
        mstore(0x3420, expmod(point, div(/*trace_length*/ mload(0x1c0), 2048), PRIME))

        // expmods[3] = point^(trace_length / 4096)
        mstore(0x3440, expmod(point, div(/*trace_length*/ mload(0x1c0), 4096), PRIME))

        // expmods[4] = point^(trace_length / 512)
        mstore(0x3460, expmod(point, div(/*trace_length*/ mload(0x1c0), 512), PRIME))

        // expmods[5] = point^(trace_length / 16384)
        mstore(0x3480, expmod(point, div(/*trace_length*/ mload(0x1c0), 16384), PRIME))

        // expmods[6] = point^trace_length
        mstore(0x34a0, expmod(point, /*trace_length*/ mload(0x1c0), PRIME))

        // expmods[7] = point^(trace_length / 256)
        mstore(0x34c0, expmod(point, div(/*trace_length*/ mload(0x1c0), 256), PRIME))

        // expmods[8] = point^(trace_length / 65536)
        mstore(0x34e0, expmod(point, div(/*trace_length*/ mload(0x1c0), 65536), PRIME))

        // expmods[9] = point^(trace_length / 128)
        mstore(0x3500, expmod(point, div(/*trace_length*/ mload(0x1c0), 128), PRIME))

        // expmods[10] = point^(trace_length / 8192)
        mstore(0x3520, expmod(point, div(/*trace_length*/ mload(0x1c0), 8192), PRIME))

        // expmods[11] = point^(trace_length / 64)
        mstore(0x3540, expmod(point, div(/*trace_length*/ mload(0x1c0), 64), PRIME))

        // expmods[12] = point^(trace_length / 32768)
        mstore(0x3560, expmod(point, div(/*trace_length*/ mload(0x1c0), 32768), PRIME))

        // expmods[13] = trace_generator^(255 * trace_length / 256)
        mstore(0x3580, expmod(/*trace_generator*/ mload(0x360), div(mul(255, /*trace_length*/ mload(0x1c0)), 256), PRIME))

        // expmods[14] = trace_generator^(251 * trace_length / 256)
        mstore(0x35a0, expmod(/*trace_generator*/ mload(0x360), div(mul(251, /*trace_length*/ mload(0x1c0)), 256), PRIME))

        // expmods[15] = trace_generator^(trace_length / 2)
        mstore(0x35c0, expmod(/*trace_generator*/ mload(0x360), div(/*trace_length*/ mload(0x1c0), 2), PRIME))

        // expmods[16] = trace_generator^(31 * trace_length / 32)
        mstore(0x35e0, expmod(/*trace_generator*/ mload(0x360), div(mul(31, /*trace_length*/ mload(0x1c0)), 32), PRIME))

        // expmods[17] = trace_generator^(path_length * trace_length / 32)
        mstore(0x3600, expmod(/*trace_generator*/ mload(0x360), div(mul(/*path_length*/ mload(0x220), /*trace_length*/ mload(0x1c0)), 32), PRIME))

        // expmods[18] = trace_generator^(15 * trace_length / 16)
        mstore(0x3620, expmod(/*trace_generator*/ mload(0x360), div(mul(15, /*trace_length*/ mload(0x1c0)), 16), PRIME))

        // expmods[19] = trace_generator^(63 * trace_length / 64)
        mstore(0x3640, expmod(/*trace_generator*/ mload(0x360), div(mul(63, /*trace_length*/ mload(0x1c0)), 64), PRIME))

        // expmods[20] = trace_generator^(65536 * (trace_length / 65536 - 1))
        mstore(0x3660, expmod(/*trace_generator*/ mload(0x360), mul(65536, sub(div(/*trace_length*/ mload(0x1c0), 65536), 1)), PRIME))

        // expmods[21] = trace_generator^(65536 * (trace_length / 65536 - 1) + 49152)
        mstore(0x3680, expmod(/*trace_generator*/ mload(0x360), add(mul(65536, sub(div(/*trace_length*/ mload(0x1c0), 65536), 1)), 49152), PRIME))
...

      {
        ...
        mstore(0x39c0,
               addmod(/*point^(trace_length / 4)*/ mload(0x33e0), sub(PRIME, 1), PRIME))

        // Denominator for constraints: 'hash_pool/hash/ec_subset_sum/bit_extraction_end'.
        // denominators[1] = point^(trace_length / 1024) - trace_generator^(251 * trace_length / 256)
        mstore(0x39e0,
               addmod(
                 /*point^(trace_length / 1024)*/ mload(0x3400),
                 sub(PRIME, /*trace_generator^(251 * trace_length / 256)*/ mload(0x35a0)),
                 PRIME))
        ...
        mstore(0x3a00,
               addmod(
                 /*point^(trace_length / 1024)*/ mload(0x3400),
                 sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x3580)),
                 PRIME))
        ...
        mstore(0x3a80,
               addmod(/*point^(trace_length / 512)*/ mload(0x3460), sub(PRIME, 1), PRIME))

        // Denominator for constraints: 'state_transition/merkle_update/side_bit_extraction/zero'.
        // denominators[7] = point^(trace_length / 16384) - trace_generator^(path_length * trace_length / 32)
        mstore(0x3aa0,
               addmod(
                 /*point^(trace_length / 16384)*/ mload(0x3480),
                 sub(PRIME, /*trace_generator^(path_length * trace_length / 32)*/ mload(0x3600)),
                 PRIME))
        ...
        mstore(0x3ac0,
               addmod(/*point^trace_length*/ mload(0x34a0), sub(PRIME, 1), PRIME))
        ...
        // denominators[9] = point^(trace_length / 256) - trace_generator^(251 * trace_length / 256)
        mstore(0x3ae0,
               addmod(
                 /*point^(trace_length / 256)*/ mload(0x34c0),
                 sub(PRIME, /*trace_generator^(251 * trace_length / 256)*/ mload(0x35a0)),
                 PRIME))
        ...
        mstore(0x3b20,
               addmod(/*point^(trace_length / 256)*/ mload(0x34c0), sub(PRIME, 1), PRIME))
        ...
        mstore(0x3b40,
               addmod(/*point^(trace_length / 16384)*/ mload(0x3480), sub(PRIME, 1), PRIME))
        ...
        mstore(0x3b60,
               addmod(/*point^(trace_length / 65536)*/ mload(0x34e0), sub(PRIME, 1), PRIME))
        ...
        mstore(0x3b80,
               addmod(/*point^(trace_length / 128)*/ mload(0x3500), sub(PRIME, 1), PRIME))
        ...
        mstore(0x3ba0,
               addmod(
                 /*point^(trace_length / 8192)*/ mload(0x3520),
                 sub(PRIME, /*trace_generator^(63 * trace_length / 64)*/ mload(0x3640)),
                 PRIME))
        ...
        mstore(0x3bc0,
               addmod(/*point^(trace_length / 64)*/ mload(0x3540), sub(PRIME, 1), PRIME))
        ...
        mstore(0x3be0,
               addmod(
                 /*point^(trace_length / 32768)*/ mload(0x3560),
                 sub(PRIME, /*trace_generator^(251 * trace_length / 256)*/ mload(0x35a0)),
                 PRIME))
        ...
        mstore(0x3c60,
               addmod(/*point^(trace_length / 32768)*/ mload(0x3560), sub(PRIME, 1), PRIME))
        ...
        // denominators[22] = point^(trace_length / 8192) - 1
        mstore(0x3c80,
               addmod(/*point^(trace_length / 8192)*/ mload(0x3520), sub(PRIME, 1), PRIME))

        // Denominator for constraints: 'initial_root'.
        // denominators[23] = point - 1
        mstore(0x3ca0,
               addmod(point, sub(PRIME, 1), PRIME))

        // Denominator for constraints: 'final_root'.
        // denominators[24] = point - trace_generator^(65536 * (trace_length / 65536 - 1))
        mstore(0x3cc0,
               addmod(
                 point,
                 sub(PRIME, /*trace_generator^(65536 * (trace_length / 65536 - 1))*/ mload(0x3660)),
                 PRIME))
...

      {
        ...
        let products_to_values_offset := 0x320
        let prod := 1
        let partial_product_end_ptr := 0x39c0
        for { let partial_product_ptr := 0x36a0 }
        ...
        let first_partial_product_ptr := 0x36a0
        ...
        for { let current_partial_product_ptr := 0x39c0
...

      {
        ...
        mstore(0x3d00,
               addmod(
                 /*point^(trace_length / 2048)*/ mload(0x3420),
                 sub(PRIME, /*trace_generator^(trace_length / 2)*/ mload(0x35c0)),
                 PRIME))
        ...
        mstore(0x3d20,
               addmod(
                 /*point^(trace_length / 16384)*/ mload(0x3480),
                 sub(PRIME, /*trace_generator^(31 * trace_length / 32)*/ mload(0x35e0)),
                 PRIME))
        ...
        mstore(0x3d60,
               addmod(
                 /*point^(trace_length / 512)*/ mload(0x3460),
                 sub(PRIME, /*trace_generator^(trace_length / 2)*/ mload(0x35c0)),
                 PRIME))
        ...
        mstore(0x3d80,
               mulmod(
                 ...
                 addmod(
                   /*point^(trace_length / 16384)*/ mload(0x3480),
                   sub(PRIME, /*trace_generator^(15 * trace_length / 16)*/ mload(0x3620)),
                   PRIME),
                 PRIME))
        ...
        // numerators[7] = point^(trace_length / 16384) - trace_generator^(255 * trace_length / 256)
        mstore(0x3dc0,
               addmod(
                 /*point^(trace_length / 16384)*/ mload(0x3480),
                 sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x3580)),
        ...
        // numerators[8] = point^(trace_length / 32768) - trace_generator^(255 * trace_length / 256)
        mstore(0x3de0,
               addmod(
                 /*point^(trace_length / 32768)*/ mload(0x3560),
                 sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x3580)),
        ...
        // numerators[9] = point - trace_generator^(65536 * (trace_length / 65536 - 1) + 49152)
        mstore(0x3e00,
               addmod(
                 point,
                 sub(
                   PRIME,
                   /*trace_generator^(65536 * (trace_length / 65536 - 1) + 49152)*/ mload(0x3680)),
                 PRIME))
        ...
        // adjustments[0] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), trace_length / 1024, trace_length / 4)
        mstore(0x3e20,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), div(/*trace_length*/ mload(0x1c0), 1024), div(/*trace_length*/ mload(0x1c0), 4)), PRIME))
        ...
        // adjustments[1] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 1024)
        mstore(0x3e40,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 1024)), PRIME))

        // Adjustment polynomial for constraints 'hash_pool/hash/copy_point/x', 'hash_pool/hash/copy_point/y'.
        // adjustments[2] = point^degree_adjustment(composition_degree_bound, trace_length - 1, trace_length / 2048, trace_length / 1024)
        mstore(0x3e60,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), div(/*trace_length*/ mload(0x1c0), 2048), div(/*trace_length*/ mload(0x1c0), 1024)), PRIME))

        // Adjustment polynomial for constraints 'hash_pool/hash/init/x', 'hash_pool/hash/init/y'.
        // adjustments[3] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 2048)
        mstore(0x3e80,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 2048)), PRIME))

        // Adjustment polynomial for constraints 'hash_pool/output_to_input'.
        // adjustments[4] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 4096)
        mstore(0x3ea0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 4096)), PRIME))
        ...
        // adjustments[5] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), trace_length / 16384, trace_length / 512)
        mstore(0x3ec0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), div(/*trace_length*/ mload(0x1c0), 16384), div(/*trace_length*/ mload(0x1c0), 512)), PRIME))
        ...
        // adjustments[6] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 16384)
        mstore(0x3ee0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 16384)), PRIME))
        ...
        // adjustments[7] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), trace_length / 256, trace_length)
        mstore(0x3f00,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), div(/*trace_length*/ mload(0x1c0), 256), /*trace_length*/ mload(0x1c0)), PRIME))
        ...
        // adjustments[8] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 256)
        mstore(0x3f20,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 256)), PRIME))

        // Adjustment polynomial for constraints 'state_transition/merkle_update/prev_authentication/hashes/copy_point/x', 'state_transition/merkle_update/prev_authentication/hashes/copy_point/y', 'state_transition/merkle_update/new_authentication/hashes/copy_point/x', 'state_transition/merkle_update/new_authentication/hashes/copy_point/y'.
        // adjustments[9] = point^degree_adjustment(composition_degree_bound, trace_length - 1, trace_length / 512, trace_length / 256)
        mstore(0x3f40,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), div(/*trace_length*/ mload(0x1c0), 512), div(/*trace_length*/ mload(0x1c0), 256)), PRIME))
        ...
        // adjustments[10] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 512)
        mstore(0x3f60,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 512)), PRIME))
        ...
        // adjustments[11] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), trace_length / 16384 + trace_length / 16384, trace_length / 512)
        mstore(0x3f80,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), add(
        ...
        // adjustments[12] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), 0, trace_length / 16384)
        mstore(0x3fa0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), 0, div(/*trace_length*/ mload(0x1c0), 16384)), PRIME))
        ...
        // adjustments[13] = point^degree_adjustment(composition_degree_bound, trace_length - 1 + trace_length / 65536 - 1, 0, trace_length / 65536)
        mstore(0x3fc0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), add(
        ...
        // adjustments[14] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), trace_length / 8192, trace_length / 128)
        mstore(0x3fe0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), div(/*trace_length*/ mload(0x1c0), 8192), div(/*trace_length*/ mload(0x1c0), 128)), PRIME))

        // Adjustment polynomial for constraints 'amounts_range_check/zero'.
        // adjustments[15] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 8192)
        mstore(0x4000,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 8192)), PRIME))
        ...
        // adjustments[16] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), 0, trace_length / 65536)
        mstore(0x4020,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), 0, div(/*trace_length*/ mload(0x1c0), 65536)), PRIME))
        ...
        // adjustments[17] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), trace_length / 16384, trace_length / 64)
        mstore(0x4040,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), div(/*trace_length*/ mload(0x1c0), 16384), div(/*trace_length*/ mload(0x1c0), 64)), PRIME))

        // Adjustment polynomial for constraints 'sig_verify/exponentiate_generator/booleanity_test', 'sig_verify/exponentiate_generator/add_points/slope', 'sig_verify/exponentiate_generator/add_points/x', 'sig_verify/exponentiate_generator/add_points/y', 'sig_verify/exponentiate_generator/add_points/x_diff_inv', 'sig_verify/exponentiate_generator/copy_point/x', 'sig_verify/exponentiate_generator/copy_point/y'.
        // adjustments[18] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), trace_length / 32768, trace_length / 128)
        mstore(0x4060,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), div(/*trace_length*/ mload(0x1c0), 32768), div(/*trace_length*/ mload(0x1c0), 128)), PRIME))
        ...
        // adjustments[19] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 32768)
        mstore(0x4080,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, div(/*trace_length*/ mload(0x1c0), 32768)), PRIME))
        ...
        // adjustments[20] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), 0, trace_length / 32768)
        mstore(0x40a0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), 0, div(/*trace_length*/ mload(0x1c0), 32768)), PRIME))
        ...
        // adjustments[21] = point^degree_adjustment(composition_degree_bound, trace_length - 1 + n_modifications, 0, trace_length / 65536)
        mstore(0x40c0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), add(sub(/*trace_length*/ mload(0x1c0), 1), /*n_modifications*/ mload(0x2e0)), 0, div(/*trace_length*/ mload(0x1c0), 65536)), PRIME))
        ...
        // adjustments[22] = point^degree_adjustment(composition_degree_bound, 2 * (trace_length - 1), 0, trace_length / 8192)
        mstore(0x40e0,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), mul(2, sub(/*trace_length*/ mload(0x1c0), 1)), 0, div(/*trace_length*/ mload(0x1c0), 8192)), PRIME))

        // Adjustment polynomial for constraints 'initial_root', 'final_root'.
        // adjustments[23] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 0, 1)
        mstore(0x4100,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 0, 1), PRIME))

        // Adjustment polynomial for constraints 'copy_merkle_roots'.
        // adjustments[24] = point^degree_adjustment(composition_degree_bound, trace_length - 1, 1, trace_length / 16384)
        mstore(0x4120,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), sub(/*trace_length*/ mload(0x1c0), 1), 1, div(/*trace_length*/ mload(0x1c0), 16384)), PRIME))

        // Adjustment polynomial for constraints 'copy_merkle_roots_modification'.
        // adjustments[25] = point^degree_adjustment(composition_degree_bound, trace_length - 1 + n_settlements, 0, trace_length / 65536)
        mstore(0x4140,
               expmod(point, degree_adjustment(/*composition_degree_bound*/ mload(0x3180), add(sub(/*trace_length*/ mload(0x1c0), 1), /*n_settlements*/ mload(0x340)), 0, div(/*trace_length*/ mload(0x1c0), 65536)), PRIME))
...

      {
        ...
        let val := addmod(
          /*column8_row3*/ mload(0x2700),
          sub(
            PRIME,
            addmod(/*column8_row7*/ mload(0x2760), /*column8_row7*/ mload(0x2760), PRIME)),
          PRIME)
        mstore(0x31a0, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/hash_pool/hash/ec_subset_sum/bit*/ mload(0x31a0),
          addmod(
            /*intermediate_value/hash_pool/hash/ec_subset_sum/bit*/ mload(0x31a0),
            sub(PRIME, 1),
            PRIME),
        ...
        let val := /*column8_row3*/ mload(0x2700)
        ...
        let val := addmod(
          ...
          sub(
            PRIME,
            mulmod(
              /*column8_row1*/ mload(0x26c0),
              addmod(
                /*column8_row0*/ mload(0x26a0),
        ...
        let val := addmod(
          mulmod(/*column8_row1*/ mload(0x26c0), /*column8_row1*/ mload(0x26c0), PRIME),
          sub(
            PRIME,
            mulmod(
              /*intermediate_value/hash_pool/hash/ec_subset_sum/bit*/ mload(0x31a0),
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/hash_pool/hash/ec_subset_sum/bit*/ mload(0x31a0),
            addmod(/*column8_row2*/ mload(0x26e0), /*column8_row6*/ mload(0x2740), PRIME),
            PRIME),
          sub(
            PRIME,
            mulmod(
              /*column8_row1*/ mload(0x26c0),
              addmod(/*column8_row0*/ mload(0x26a0), sub(PRIME, /*column8_row4*/ mload(0x2720)), PRIME),
              PRIME)),
          PRIME)
        ...
        let val := addmod(
          1,
          sub(PRIME, /*intermediate_value/hash_pool/hash/ec_subset_sum/bit*/ mload(0x31a0)),
          PRIME)
        mstore(0x31c0, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/hash_pool/hash/ec_subset_sum/bit_neg*/ mload(0x31c0),
          addmod(/*column8_row4*/ mload(0x2720), sub(PRIME, /*column8_row0*/ mload(0x26a0)), PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*intermediate_value/hash_pool/hash/ec_subset_sum/bit_neg*/ mload(0x31c0),
          addmod(/*column8_row6*/ mload(0x2740), sub(PRIME, /*column8_row2*/ mload(0x26e0)), PRIME),
          PRIME)
        ...
        let val := addmod(
          /*column8_row1024*/ mload(0x27e0),
          sub(PRIME, /*column8_row1020*/ mload(0x2780)),
          PRIME)
        ...
        let val := addmod(
          /*column8_row1026*/ mload(0x2800),
          sub(PRIME, /*column8_row1022*/ mload(0x27c0)),
          PRIME)
        ...
        let val := addmod(/*column8_row0*/ mload(0x26a0), sub(PRIME, /*shift_point.x*/ mload(0x1e0)), PRIME)
        ...
        let val := addmod(/*column8_row2*/ mload(0x26e0), sub(PRIME, /*shift_point.y*/ mload(0x200)), PRIME)
        ...
        let val := addmod(
          /*column8_row2044*/ mload(0x2840),
          sub(PRIME, /*column8_row2051*/ mload(0x2860)),
          PRIME)
        ...
        let val := addmod(
          /*column6_row255*/ mload(0x2540),
          sub(
            PRIME,
            addmod(/*column6_row767*/ mload(0x2560), /*column6_row767*/ mload(0x2560), PRIME)),
          PRIME)
        mstore(0x31e0, val)
        }
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/state_transition/merkle_update/side_bit_extraction/bit_0*/ mload(0x31e0),
            /*intermediate_value/state_transition/merkle_update/side_bit_extraction/bit_0*/ mload(0x31e0),
            PRIME),
          sub(
            PRIME,
        ...
        let val := /*column6_row255*/ mload(0x2540)
        ...
        let val := addmod(
          ...
          sub(
            PRIME,
            addmod(/*column3_row1*/ mload(0x2340), /*column3_row1*/ mload(0x2340), PRIME)),
          PRIME)
        mstore(0x3200, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit*/ mload(0x3200),
          addmod(
            /*intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit*/ mload(0x3200),
            sub(PRIME, 1),
            PRIME),
        ...
        let val := /*column3_row0*/ mload(0x2320)
        ...
        let val := addmod(
          ...
          sub(
            PRIME,
            mulmod(
              /*column2_row0*/ mload(0x2300),
              addmod(
                /*column0_row0*/ mload(0x21a0),
        ...
        let val := addmod(
          mulmod(/*column2_row0*/ mload(0x2300), /*column2_row0*/ mload(0x2300), PRIME),
          sub(
            PRIME,
            mulmod(
              /*intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit*/ mload(0x3200),
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit*/ mload(0x3200),
            addmod(/*column1_row0*/ mload(0x2280), /*column1_row1*/ mload(0x22a0), PRIME),
            PRIME),
          sub(
            PRIME,
            mulmod(
              /*column2_row0*/ mload(0x2300),
              addmod(/*column0_row0*/ mload(0x21a0), sub(PRIME, /*column0_row1*/ mload(0x21c0)), PRIME),
              PRIME)),
          PRIME)
        ...
        let val := mulmod(
          /*intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit_neg*/ mload(0x3220),
          addmod(/*column0_row1*/ mload(0x21c0), sub(PRIME, /*column0_row0*/ mload(0x21a0)), PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*intermediate_value/state_transition/merkle_update/prev_authentication/hashes/ec_subset_sum/bit_neg*/ mload(0x3220),
          addmod(/*column1_row1*/ mload(0x22a0), sub(PRIME, /*column1_row0*/ mload(0x2280)), PRIME),
          PRIME)
        ...
        let val := addmod(
          /*column0_row256*/ mload(0x2200),
          sub(PRIME, /*column0_row255*/ mload(0x21e0)),
          PRIME)
        ...
        let val := addmod(
          /*column1_row256*/ mload(0x22e0),
          sub(PRIME, /*column1_row255*/ mload(0x22c0)),
          PRIME)
        ...
        let val := addmod(/*column0_row0*/ mload(0x21a0), sub(PRIME, /*shift_point.x*/ mload(0x1e0)), PRIME)
        ...
        let val := addmod(/*column1_row0*/ mload(0x2280), sub(PRIME, /*shift_point.y*/ mload(0x200)), PRIME)
        ...
        let val := addmod(
          /*column6_row767*/ mload(0x2560),
          sub(
            PRIME,
            addmod(/*column6_row1279*/ mload(0x2580), /*column6_row1279*/ mload(0x2580), PRIME)),
          PRIME)
        mstore(0x3240, val)
        }
        ...
        let val := mulmod(
          addmod(
            ...
            sub(
              PRIME,
              /*intermediate_value/state_transition/merkle_update/side_bit_extraction/bit_1*/ mload(0x3240)),
            PRIME),
          addmod(
            /*column0_row511*/ mload(0x2220),
            sub(PRIME, /*column3_row512*/ mload(0x2380)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          ...
          addmod(
            /*column0_row511*/ mload(0x2220),
            sub(PRIME, /*column3_row768*/ mload(0x23a0)),
            PRIME),
          PRIME)
        ...
        let val := addmod(
          /*column7_row0*/ mload(0x2600),
          sub(
            PRIME,
            addmod(/*column7_row1*/ mload(0x2620), /*column7_row1*/ mload(0x2620), PRIME)),
          PRIME)
        mstore(0x3260, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit*/ mload(0x3260),
          addmod(
            /*intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit*/ mload(0x3260),
            sub(PRIME, 1),
            PRIME),
        ...
        let val := /*column7_row0*/ mload(0x2600)
        ...
        let val := addmod(
          mulmod(/*column6_row0*/ mload(0x2520), /*column6_row0*/ mload(0x2520), PRIME),
          sub(
            PRIME,
            mulmod(
              /*intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit*/ mload(0x3260),
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit*/ mload(0x3260),
            addmod(/*column5_row0*/ mload(0x24a0), /*column5_row1*/ mload(0x24c0), PRIME),
            PRIME),
          sub(
            PRIME,
            mulmod(
              /*column6_row0*/ mload(0x2520),
              addmod(/*column4_row0*/ mload(0x23c0), sub(PRIME, /*column4_row1*/ mload(0x23e0)), PRIME),
              PRIME)),
          PRIME)
        ...
        let val := mulmod(
          /*intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit_neg*/ mload(0x3280),
          addmod(/*column4_row1*/ mload(0x23e0), sub(PRIME, /*column4_row0*/ mload(0x23c0)), PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*intermediate_value/state_transition/merkle_update/new_authentication/hashes/ec_subset_sum/bit_neg*/ mload(0x3280),
          addmod(/*column5_row1*/ mload(0x24c0), sub(PRIME, /*column5_row0*/ mload(0x24a0)), PRIME),
          PRIME)
        ...
        let val := addmod(
          /*column4_row256*/ mload(0x2420),
          sub(PRIME, /*column4_row255*/ mload(0x2400)),
          PRIME)
        ...
        let val := addmod(
          /*column5_row256*/ mload(0x2500),
          sub(PRIME, /*column5_row255*/ mload(0x24e0)),
          PRIME)
        ...
        let val := addmod(/*column4_row0*/ mload(0x23c0), sub(PRIME, /*shift_point.x*/ mload(0x1e0)), PRIME)
        ...
        let val := addmod(/*column5_row0*/ mload(0x24a0), sub(PRIME, /*shift_point.y*/ mload(0x200)), PRIME)
        ...
        let val := mulmod(
          addmod(
            ...
            PRIME),
          addmod(
            /*column4_row511*/ mload(0x2440),
            sub(PRIME, /*column7_row512*/ mload(0x2660)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          ...
          addmod(
            /*column4_row511*/ mload(0x2440),
            sub(PRIME, /*column7_row768*/ mload(0x2680)),
            PRIME),
          PRIME)
        ...
        let val := addmod(
          /*intermediate_value/state_transition/merkle_update/prev_authentication/sibling_0*/ mload(0x32a0),
          sub(
            PRIME,
            /*intermediate_value/state_transition/merkle_update/new_authentication/sibling_0*/ mload(0x32c0)),
          PRIME)
        ...
        let val := addmod(
          /*intermediate_value/state_transition/merkle_update/prev_authentication/leaf_0*/ mload(0x32e0),
          sub(PRIME, /*column8_row4092*/ mload(0x28c0)),
          PRIME)
        ...
        let val := addmod(
          /*intermediate_value/state_transition/merkle_update/new_authentication/leaf_0*/ mload(0x3300),
          sub(PRIME, /*column8_row12284*/ mload(0x2a20)),
          PRIME)
        ...
        let val := addmod(
          /*column9_row4*/ mload(0x2be0),
          sub(
            PRIME,
            addmod(/*column9_row132*/ mload(0x2e20), /*column9_row132*/ mload(0x2e20), PRIME)),
          PRIME)
        mstore(0x3320, val)
        }
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/amounts_range_check/bit_0*/ mload(0x3320),
            /*intermediate_value/amounts_range_check/bit_0*/ mload(0x3320),
            PRIME),
          sub(PRIME, /*intermediate_value/amounts_range_check/bit_0*/ mload(0x3320)),
          PRIME)
        ...
        let val := /*column9_row4*/ mload(0x2be0)
        ...
        let val := mulmod(
          ...
          addmod(
            addmod(
              /*column8_row3075*/ mload(0x28a0),
              sub(PRIME, /*column8_row11267*/ mload(0x2a00)),
              PRIME),
            sub(
              PRIME,
              addmod(
                /*column8_row27651*/ mload(0x2aa0),
                sub(PRIME, /*column8_row19459*/ mload(0x2a60)),
                PRIME)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          ...
          addmod(
            addmod(
              /*column8_row35843*/ mload(0x2ac0),
              sub(PRIME, /*column8_row44035*/ mload(0x2b60)),
              PRIME),
            sub(
              PRIME,
              addmod(
                /*column8_row60419*/ mload(0x2ba0),
                sub(PRIME, /*column8_row52227*/ mload(0x2b80)),
                PRIME)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(/*column9_row0*/ mload(0x2bc0), /*column9_row0*/ mload(0x2bc0), PRIME)
        mstore(0x3340, val)
        }
        ...
        let val := addmod(
          addmod(
            addmod(
              addmod(
                /*intermediate_value/sig_verify/doubling_key/x_squared*/ mload(0x3340),
                /*intermediate_value/sig_verify/doubling_key/x_squared*/ mload(0x3340),
                PRIME),
              /*intermediate_value/sig_verify/doubling_key/x_squared*/ mload(0x3340),
              PRIME),
          ...
          sub(
            PRIME,
            mulmod(
              addmod(/*column9_row32*/ mload(0x2c80), /*column9_row32*/ mload(0x2c80), PRIME),
              /*column9_row16*/ mload(0x2c20),
              PRIME)),
          PRIME)
        ...
        let val := addmod(
          mulmod(/*column9_row16*/ mload(0x2c20), /*column9_row16*/ mload(0x2c20), PRIME),
          sub(
            PRIME,
            addmod(
              addmod(/*column9_row0*/ mload(0x2bc0), /*column9_row0*/ mload(0x2bc0), PRIME),
              /*column9_row64*/ mload(0x2d20),
              PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[118] + coefficients[119] * adjustments[17])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          addmod(/*column9_row32*/ mload(0x2c80), /*column9_row96*/ mload(0x2dc0), PRIME),
          sub(
            PRIME,
            mulmod(
              /*column9_row16*/ mload(0x2c20),
              addmod(/*column9_row0*/ mload(0x2bc0), sub(PRIME, /*column9_row64*/ mload(0x2d20)), PRIME),
              PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[120] + coefficients[121] * adjustments[17])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          /*column9_row20*/ mload(0x2c40),
          sub(
            PRIME,
            addmod(/*column9_row148*/ mload(0x2e40), /*column9_row148*/ mload(0x2e40), PRIME)),
          PRIME)
        mstore(0x3360, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/sig_verify/exponentiate_generator/bit*/ mload(0x3360),
          addmod(
            /*intermediate_value/sig_verify/exponentiate_generator/bit*/ mload(0x3360),
            sub(PRIME, 1),
            PRIME),
        ...
        // res += val * (coefficients[122] + coefficients[123] * adjustments[18])
        res := addmod(res,
                      mulmod(val,
                             add(/*coefficients[122]*/ mload(0x12e0),
                                 mulmod(/*coefficients[123]*/ mload(0x1300),
                                        /*adjustments[18]*/mload(0x4060),
                PRIME)),
                PRIME),
                PRIME)
        }
        ...
        let val := /*column9_row20*/ mload(0x2c40)
        ...
        // res += val * (coefficients[126] + coefficients[127] * adjustments[19])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          ...
          sub(
            PRIME,
            mulmod(
              /*column9_row100*/ mload(0x2de0),
              addmod(
                /*column9_row68*/ mload(0x2d40),
        ...
        // res += val * (coefficients[128] + coefficients[129] * adjustments[18])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(/*column9_row100*/ mload(0x2de0), /*column9_row100*/ mload(0x2de0), PRIME),
          sub(
            PRIME,
            mulmod(
              /*intermediate_value/sig_verify/exponentiate_generator/bit*/ mload(0x3360),
        ...
        // res += val * (coefficients[130] + coefficients[131] * adjustments[18])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/sig_verify/exponentiate_generator/bit*/ mload(0x3360),
            addmod(/*column9_row36*/ mload(0x2ca0), /*column9_row164*/ mload(0x2e60), PRIME),
            PRIME),
          sub(
            PRIME,
            mulmod(
              ...
              addmod(
                /*column9_row68*/ mload(0x2d40),
                sub(PRIME, /*column9_row196*/ mload(0x2e80)),
                PRIME),
              PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[132] + coefficients[133] * adjustments[18])
        res := addmod(res,
                      mulmod(val,
        ...
        // res += val * (coefficients[134] + coefficients[135] * adjustments[18])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          1,
          sub(PRIME, /*intermediate_value/sig_verify/exponentiate_generator/bit*/ mload(0x3360)),
          PRIME)
        mstore(0x3380, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/sig_verify/exponentiate_generator/bit_neg*/ mload(0x3380),
          addmod(
            /*column9_row196*/ mload(0x2e80),
            sub(PRIME, /*column9_row68*/ mload(0x2d40)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*intermediate_value/sig_verify/exponentiate_generator/bit_neg*/ mload(0x3380),
          addmod(
            /*column9_row164*/ mload(0x2e60),
            sub(PRIME, /*column9_row36*/ mload(0x2ca0)),
            PRIME),
          PRIME)
        ...
        let val := addmod(
          /*column9_row24*/ mload(0x2c60),
          sub(
            PRIME,
            addmod(/*column9_row88*/ mload(0x2da0), /*column9_row88*/ mload(0x2da0), PRIME)),
          PRIME)
        mstore(0x33a0, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/sig_verify/exponentiate_key/bit*/ mload(0x33a0),
          addmod(
            /*intermediate_value/sig_verify/exponentiate_key/bit*/ mload(0x33a0),
            sub(PRIME, 1),
            PRIME),
        ...
        let val := /*column9_row24*/ mload(0x2c60)
        ...
        // res += val * (coefficients[142] + coefficients[143] * adjustments[6])
        res := addmod(res,
                      mulmod(val,
        ...
        // res += val * (coefficients[144] + coefficients[145] * adjustments[6])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/sig_verify/exponentiate_key/bit*/ mload(0x33a0),
            addmod(/*column9_row8*/ mload(0x2c00), sub(PRIME, /*column9_row32*/ mload(0x2c80)), PRIME),
            PRIME),
          sub(
            PRIME,
            mulmod(
              /*column9_row40*/ mload(0x2cc0),
              addmod(/*column9_row48*/ mload(0x2ce0), sub(PRIME, /*column9_row0*/ mload(0x2bc0)), PRIME),
              PRIME)),
          PRIME)
        ...
        let val := addmod(
          mulmod(/*column9_row40*/ mload(0x2cc0), /*column9_row40*/ mload(0x2cc0), PRIME),
          sub(
            PRIME,
            mulmod(
              /*intermediate_value/sig_verify/exponentiate_key/bit*/ mload(0x33a0),
              addmod(
                addmod(/*column9_row48*/ mload(0x2ce0), /*column9_row0*/ mload(0x2bc0), PRIME),
                /*column9_row112*/ mload(0x2e00),
                PRIME),
              PRIME)),
          PRIME)
        ...
        let val := addmod(
          mulmod(
            /*intermediate_value/sig_verify/exponentiate_key/bit*/ mload(0x33a0),
            addmod(/*column9_row8*/ mload(0x2c00), /*column9_row72*/ mload(0x2d60), PRIME),
            PRIME),
          sub(
            PRIME,
            mulmod(
              /*column9_row40*/ mload(0x2cc0),
              addmod(
                /*column9_row48*/ mload(0x2ce0),
                sub(PRIME, /*column9_row112*/ mload(0x2e00)),
                PRIME),
              PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[152] + coefficients[153] * adjustments[17])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          1,
          sub(PRIME, /*intermediate_value/sig_verify/exponentiate_key/bit*/ mload(0x33a0)),
          PRIME)
        mstore(0x33c0, val)
        }
        ...
        let val := mulmod(
          /*intermediate_value/sig_verify/exponentiate_key/bit_neg*/ mload(0x33c0),
          addmod(
            /*column9_row112*/ mload(0x2e00),
            sub(PRIME, /*column9_row48*/ mload(0x2ce0)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[154] + coefficients[155] * adjustments[17])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          /*intermediate_value/sig_verify/exponentiate_key/bit_neg*/ mload(0x33c0),
          addmod(/*column9_row72*/ mload(0x2d60), sub(PRIME, /*column9_row8*/ mload(0x2c00)), PRIME),
          PRIME)
        ...
        // res += val * (coefficients[156] + coefficients[157] * adjustments[17])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(/*column9_row68*/ mload(0x2d40), sub(PRIME, /*shift_point.x*/ mload(0x1e0)), PRIME)
        ...
        let val := addmod(/*column9_row36*/ mload(0x2ca0), /*shift_point.y*/ mload(0x200), PRIME)
        ...
        let val := addmod(/*column9_row48*/ mload(0x2ce0), sub(PRIME, /*shift_point.x*/ mload(0x1e0)), PRIME)
        ...
        // res += val * (coefficients[162] + coefficients[163] * adjustments[6])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(/*column9_row8*/ mload(0x2c00), sub(PRIME, /*shift_point.y*/ mload(0x200)), PRIME)
        ...
        // res += val * (coefficients[164] + coefficients[165] * adjustments[6])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          addmod(
            /*column9_row32676*/ mload(0x2fa0),
            sub(PRIME, /*column9_row16328*/ mload(0x2ec0)),
            PRIME),
          sub(
            PRIME,
            mulmod(
              /*column9_row32724*/ mload(0x3000),
              addmod(
                /*column9_row32708*/ mload(0x2fc0),
                sub(PRIME, /*column9_row16368*/ mload(0x2f20)),
                PRIME),
              PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[166] + coefficients[167] * adjustments[20])
        res := addmod(res,
                      mulmod(val,
                             add(/*coefficients[166]*/ mload(0x1860),
                                 mulmod(/*coefficients[167]*/ mload(0x1880),
                                        /*adjustments[20]*/mload(0x40a0),
                PRIME)),
                PRIME),
                PRIME)
        }
        ...
        let val := addmod(
          mulmod(/*column9_row32724*/ mload(0x3000), /*column9_row32724*/ mload(0x3000), PRIME),
          sub(
            PRIME,
            addmod(
              addmod(/*column9_row32708*/ mload(0x2fc0), /*column9_row16368*/ mload(0x2f20), PRIME),
              /*column9_row16384*/ mload(0x2f60),
              PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[168] + coefficients[169] * adjustments[20])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          addmod(/*column9_row32676*/ mload(0x2fa0), /*column9_row16416*/ mload(0x2f80), PRIME),
          sub(
            PRIME,
            mulmod(
              /*column9_row32724*/ mload(0x3000),
              addmod(
                /*column9_row32708*/ mload(0x2fc0),
                sub(PRIME, /*column9_row16384*/ mload(0x2f60)),
                PRIME),
              PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[170] + coefficients[171] * adjustments[20])
        res := addmod(res,
                      mulmod(val,
        ...
        // res += val * (coefficients[172] + coefficients[173] * adjustments[20])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          addmod(/*column9_row32712*/ mload(0x2fe0), /*shift_point.y*/ mload(0x200), PRIME),
          sub(
            PRIME,
            mulmod(
              /*column8_row3069*/ mload(0x2880),
              addmod(
                /*column9_row32752*/ mload(0x3060),
        ...
        // res += val * (coefficients[174] + coefficients[175] * adjustments[20])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(/*column8_row3069*/ mload(0x2880), /*column8_row3069*/ mload(0x2880), PRIME),
          sub(
            PRIME,
            addmod(
              addmod(/*column9_row32752*/ mload(0x3060), /*shift_point.x*/ mload(0x1e0), PRIME),
              /*column9_row24*/ mload(0x2c60),
              PRIME)),
          PRIME)
        ...
        let val := addmod(
          mulmod(/*column9_row20*/ mload(0x2c40), /*column8_row11261*/ mload(0x29e0), PRIME),
          sub(PRIME, 1),
          PRIME)
        ...
        let val := addmod(
          mulmod(/*column9_row24*/ mload(0x2c60), /*column9_row16336*/ mload(0x2ee0), PRIME),
          sub(PRIME, 1),
          PRIME)
        ...
        let val := addmod(
          /*column8_row27645*/ mload(0x2a80),
          sub(
            PRIME,
            mulmod(/*column9_row0*/ mload(0x2bc0), /*column9_row0*/ mload(0x2bc0), PRIME)),
          PRIME)
        ...
        let val := addmod(
          mulmod(/*column9_row32*/ mload(0x2c80), /*column9_row32*/ mload(0x2c80), PRIME),
          sub(
            PRIME,
            addmod(
              addmod(
                mulmod(/*column9_row0*/ mload(0x2bc0), /*column8_row27645*/ mload(0x2a80), PRIME),
                mulmod(/*sig_config.alpha*/ mload(0x240), /*column9_row0*/ mload(0x2bc0), PRIME),
                PRIME),
                ...
                addmod(
                  mulmod(
                    addmod(
                      mulmod(
                        addmod(
                          mulmod(/*column6_row255*/ mload(0x2540), /*vault_shift*/ mload(0x280), PRIME),
                          /*column6_row49407*/ mload(0x25e0),
                          PRIME),
                        /*amount_shift*/ mload(0x2a0),
                        PRIME),
                      /*column9_row4*/ mload(0x2be0),
                      PRIME),
                    /*amount_shift*/ mload(0x2a0),
        ...
        // res += val * (coefficients[188] + coefficients[189] * adjustments[16])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column8_row36867*/ mload(0x2ae0),
            sub(PRIME, /*column8_row8188*/ mload(0x2960)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[190] + coefficients[191] * adjustments[16])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column8_row37891*/ mload(0x2b00),
            sub(PRIME, /*column6_row16639*/ mload(0x25a0)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column8_row39939*/ mload(0x2b20),
            sub(PRIME, /*column6_row33023*/ mload(0x25c0)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column8_row8188*/ mload(0x2960),
            sub(PRIME, /*column9_row20*/ mload(0x2c40)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column8_row40956*/ mload(0x2b40),
            sub(PRIME, /*column9_row32788*/ mload(0x30e0)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column9_row0*/ mload(0x2bc0),
            sub(PRIME, /*column9_row16376*/ mload(0x2f40)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[200] + coefficients[201] * adjustments[21])
        res := addmod(res,
                      mulmod(val,
                             add(/*coefficients[200]*/ mload(0x1ca0),
                                 mulmod(/*coefficients[201]*/ mload(0x1cc0),
                                        /*adjustments[21]*/mload(0x40c0),
                PRIME)),
                PRIME),
                PRIME)
        }
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column8_row4099*/ mload(0x28e0),
            sub(PRIME, /*column9_row16360*/ mload(0x2f00)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[202] + coefficients[203] * adjustments[21])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          ...
          addmod(
            /*column9_row0*/ mload(0x2bc0),
            sub(PRIME, /*column9_row65528*/ mload(0x3160)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[204] + coefficients[205] * adjustments[21])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column8_row5123*/ mload(0x2920),
            sub(PRIME, /*column9_row65512*/ mload(0x3140)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[206] + coefficients[207] * adjustments[21])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          /*periodic_column/is_settlement*/ mload(0xc0),
          addmod(
            /*column9_row32768*/ mload(0x30a0),
            sub(PRIME, /*column9_row32760*/ mload(0x3080)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[208] + coefficients[209] * adjustments[21])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          ...
          addmod(
            /*column8_row4099*/ mload(0x28e0),
            sub(PRIME, /*column9_row32744*/ mload(0x3040)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[210] + coefficients[211] * adjustments[21])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          ...
          addmod(
            /*column9_row32768*/ mload(0x30a0),
            sub(PRIME, /*column9_row49144*/ mload(0x3120)),
            PRIME),
          PRIME)
        ...
        let val := mulmod(
          ...
          addmod(
            /*column8_row5123*/ mload(0x2920),
            sub(PRIME, /*column9_row49128*/ mload(0x3100)),
            PRIME),
          PRIME)
        ...
        // res += val * (coefficients[214] + coefficients[215] * adjustments[21])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(
          /*column8_row1021*/ mload(0x27a0),
          addmod(1, sub(PRIME, /*column8_row1021*/ mload(0x27a0)), PRIME),
          PRIME)
        ...
        // res += val * (coefficients[216] + coefficients[217] * adjustments[22])
        res := addmod(res,
                      mulmod(val,
                             add(/*coefficients[216]*/ mload(0x1ea0),
                                 mulmod(/*coefficients[217]*/ mload(0x1ec0),
                                        /*adjustments[22]*/mload(0x40e0),
                PRIME)),
                PRIME),
                PRIME)
        }
        ...
        let val := mulmod(/*column8_row1021*/ mload(0x27a0), /*column8_row3075*/ mload(0x28a0), PRIME)
        ...
        // res += val * (coefficients[218] + coefficients[219] * adjustments[22])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := mulmod(/*column8_row1021*/ mload(0x27a0), /*column8_row5117*/ mload(0x2900), PRIME)
        ...
        // res += val * (coefficients[220] + coefficients[221] * adjustments[22])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(/*column8_row3075*/ mload(0x28a0), /*column8_row5117*/ mload(0x2900), PRIME),
          sub(PRIME, addmod(1, sub(PRIME, /*column8_row1021*/ mload(0x27a0)), PRIME)),
          PRIME)
        ...
        // res += val * (coefficients[222] + coefficients[223] * adjustments[22])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(
            ...
            /*column9_row16376*/ mload(0x2f40),
            PRIME),
          sub(PRIME, /*column8_row3*/ mload(0x2700)),
          PRIME)
        ...
        // res += val * (coefficients[224] + coefficients[225] * adjustments[12])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(
            ...
            /*column9_row16360*/ mload(0x2f00),
            PRIME),
          sub(PRIME, /*column8_row1027*/ mload(0x2820)),
          PRIME)
        ...
        // res += val * (coefficients[226] + coefficients[227] * adjustments[12])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          mulmod(
            addmod(1, sub(PRIME, /*column8_row9213*/ mload(0x29a0)), PRIME),
            /*column9_row16376*/ mload(0x2f40),
            PRIME),
          sub(PRIME, /*column8_row8195*/ mload(0x2980)),
          PRIME)
        ...
        let val := addmod(
          mulmod(
            ...
            /*column9_row16360*/ mload(0x2f00),
            PRIME),
          sub(PRIME, /*column8_row9219*/ mload(0x29c0)),
          PRIME)
        ...
        let val := addmod(
          /*column0_row_expr0*/ mload(0x2240),
          sub(PRIME, /*initial_root*/ mload(0x300)),
          PRIME)
        ...
        // res += val * (coefficients[232] + coefficients[233] * adjustments[23])
        res := addmod(res,
                      mulmod(val,
                             add(/*coefficients[232]*/ mload(0x20a0),
                                 mulmod(/*coefficients[233]*/ mload(0x20c0),
                                        /*adjustments[23]*/mload(0x4100),
                PRIME)),
                PRIME),
                PRIME)
        }
        ...
        let val := addmod(/*column4_row_expr1*/ mload(0x2460), sub(PRIME, /*final_root*/ mload(0x320)), PRIME)
        ...
        // res += val * (coefficients[234] + coefficients[235] * adjustments[23])
        res := addmod(res,
                      mulmod(val,
        ...
        let val := addmod(
          /*column4_row_expr0*/ mload(0x2480),
          sub(PRIME, /*column0_row_expr2*/ mload(0x2260)),
          PRIME)
        ...
        // res += val * (coefficients[236] + coefficients[237] * adjustments[24])
        res := addmod(res,
                      mulmod(val,
                             add(/*coefficients[236]*/ mload(0x2120),
                                 mulmod(/*coefficients[237]*/ mload(0x2140),
                                        /*adjustments[24]*/mload(0x4120),
                PRIME)),
                PRIME),
                PRIME)
        }
        ...
        let val := mulmod(
          ...
          addmod(
            /*column4_row_expr0*/ mload(0x2480),
            sub(PRIME, /*column4_row_expr1*/ mload(0x2460)),
            PRIME),
          PRIME)
